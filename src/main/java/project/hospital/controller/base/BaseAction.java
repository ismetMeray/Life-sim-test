...
/**
 * This class provides basic functionalities for all Action Controllers. It sets
 * the logged in account so it can be checked by the login interceptor.
 */
public abstract class BaseAction extends ActionSupport implements SessionAware, ParameterNameAware {
	...
	public String executeError() throws Exception {
		setAccount((Account) getLoginSession().get(LOGGED_IN));
		return ERROR;
	}
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.opensymphony.xwork2.interceptor.ParameterNameAware#
	 * acceptableParameterName(java.lang.String)
	 */
	@Override
